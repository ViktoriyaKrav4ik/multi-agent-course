...
def run_turn(user_text: str, thread_id: str) -> None:
    cfg = {
    ...
    while True:
        ...
        last_assistant = None
        for step in supervisor.stream(stream_input, cfg):
...
def main() -> None:
    print("Multi-agent Supervisor (hw8). Команди: exit / quit")
    print("-" * 50)
    ...
    while True:
        ...
        run_turn(user_input, session_thread)
