"""Інструменти: веб, URL, RAG, збереження звіту (save_report для HITL на Supervisor)."""
...
def save_report(filename: str, content: str) -> str:
    """Зберегти Markdown-звіт у output/. Потребує підтвердження користувача (HITL)."""
...
def knowledge_search(query: str) -> str:
    ...
    if not index_ready():
        return (
            "Локальний індекс ще не створено. З каталогу homework-lesson-8 виконайте: "
